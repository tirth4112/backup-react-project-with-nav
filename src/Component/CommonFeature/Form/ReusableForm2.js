...
function ReusableForm2({Header, initialValues, fieldDefinitions, onSubmit }) {
                    ...
                    {field.type === 'radio' && (
                      <>
                        {field.options.map((option, radioIndex) => (
                          <div key={radioIndex} className="form-check">
                            <input
                              type="radio"
                              id={`${field.name}_${radioIndex}`}
                              name={field.name}
                              value={option.value}
                              onChange={formik.handleChange}
                              onBlur={formik.handleBlur}
                            ...
                            />
                            <label
                              htmlFor={`${field.name}_${radioIndex}`}
                              className="form-check-label"
                            >
                              {option.label}
                            </label>
                    ...
                    {field.type === 'checkbox' && (
                      <>
                        {field.options.map((option, checkboxIndex) => (
                          <div key={checkboxIndex} className="form-check">
                            <input
                              type="checkbox"
                              id={`${field.name}_${checkboxIndex}`}
                              name={field.name}
                              value={option.value}
                              onChange={formik.handleChange}
                              onBlur={formik.handleBlur}
                            ...
                            />
                            <label
                              htmlFor={`${field.name}_${checkboxIndex}`}
                              className="form-check-label"
                            >
                              {option.label}
                            </label>
